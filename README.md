...
Version **0.2 — experimental** combines temporal AA/DLSS corrections, a 4K borderless DPI fix, selected engine improvements, and a locally compiled ReShade loader with automatic update checks disabled. This repository contains source changes, pinned dependency references, and build tools. Game files, personal configurations, logs, and compiled packages are not included.
...
## Install or remove a locally built package
